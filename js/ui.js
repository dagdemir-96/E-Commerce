//UI elemanlaeını bir arada tutan obje
...
//product card render eden fonksiyon
...
//sepetteki ürünü randerlayacak ürün
const renderCartItems = (cart) => {

  const cartItemHtml =  cart.length > 0
      ? cart
    .map((item) =>
      `<div class="cart-item">
                    <img
    ...
    //diziden gelen vigülleri boşluk ile kaldırdık değiştiridik
  ...
  //removeButtons içerisindeki butonlara olay izleyicisi eklemek için her bir butona addeventlistner ekle
  ...
  //quantity inpularına eriş
  const quantityInputs = document.querySelectorAll(".cart-item-quantity");
  //quantityInputs ların her birine olay izleyicisi ekle
